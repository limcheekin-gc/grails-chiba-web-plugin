...
if(!dojo._hasResource["chiba.XFormsProcessor"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
/*
This class represents the interface to the XForms processor (aka 'Chiba Web'). It is the only class
actually having dependency on DWR to handle the AJAX part of things and calling remote Java methods on
org.chiba.web.flux.FluxFacade.
*/
dojo.declare("chiba.XFormsProcessor",
        dijit._Widget,
{
    sessionKey:"",
...
if(!dojo._hasResource["chiba.ui.ControlValue"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
{                                                                                                                                                  //    tabIndex:0,
    ...
    handleEmptyRequired:function() {
        if (this.xfControl.isRequired() && this.currentValue == "") {
            ...
            if (label != undefined) {
                dijit.byId("chibaMessageToaster").setContent("'" + label.innerHTML + "' is required. Please fill in a value.", 'message');
            }else{
...
if(!dojo._hasResource["chiba.ui.input.Date"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    getControlValue:function(){
        ...
        if(notISODate == undefined){
           ...
           return this.focusNode.value;
            ...
            return dojo.date.stamp.toISOString(notISODate);
        }
    },
...
if(!dojo._hasResource["chiba.ui.UIElementFactory"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["chiba.ui.UIElementFactory"] = true;
dojo.provide("chiba.ui.UIElementFactory");


// creates all Chiba Widgets for xf:* UI Controls dependent on datatype and controltype.
dojo.declare(
        ...
        null,
{
    ...
    createWidget:function(sourceNode, controlId) {
        ...
        if(dataType != undefined && dataType.indexOf(":") != -1){
        ...
        switch (controlType) {
            case "input":
                ...
                switch (inputType.toLowerCase()) {
                    case "casimiletimeline":
                        ...
                        newWidget = new chiba.ui.timeline.TimeLine({
                    ...
                    case "caopmltree":
                        ...
                        newWidget = new chiba.ui.tree.Tree({
                            name:controlId + "-value",
                            "class":classValue,
                            xfControlId:controlId
                        }, sourceNode);
                    ...
                    case "date":
                        ...
                        newWidget = new chiba.ui.input.Date({
                            name:controlId + "-value",
                            value:xfValue,
                            "class":classValue,
                    ...
                    case "boolean":
                        ...
                        newWidget = new chiba.ui.input.Boolean({
                            name:controlId + "-value",
                            checked:xfValue,
                            "class":classValue,
                            title:dojo.attr(sourceNode,"title"),
                    ...
                    default:
                        var xfValue = sourceNode.innerHTML;
                    // 
                        newWidget = new chiba.ui.input.TextField({
                            name:controlId + "-value",
                            value:xfValue,
                            "class":classValue,
                            title:dojo.attr(sourceNode,"title"),
                ...
                switch (outputType.toLowerCase()) {
                    case "anyuri":
                        ...
                        if (mediatype == undefined || mediatype == "controlValue" || mediatype == "text") {
                            newWidget = new chiba.ui.output.Link({
                                name:controlId + "-value",
                                href:xfValue,
                                "class":classValue,
                                title:dojo.attr(sourceNode,"title"),
                                ...
                                newWidget = new chiba.ui.output.Image({
                                    name:controlId + "-value",
                                    src:xfValue,
                                    "class":classValue,
                                    title:dojo.attr(sourceNode,"title"),
                            ...
                            newWidget = new chiba.ui.output.Html({
                                name:controlId + "-value",
                                value:xfValue,
                                "class":classValue,
                                title:dojo.attr(sourceNode,"title"),
                    ...
                    default:
                        if (mediatype == undefined || mediatype == "controlValue" || mediatype == "text") {
                            newWidget = new chiba.ui.output.Plain({
                                name:controlId + "-value",
                                value:xfValue,
                                "class":classValue,
                                title:dojo.attr(sourceNode,"title"),
            ...
            case "range":
                ...
                if(dojo.attr(sourceNode,"appearance")=="chiba:rating"){
                    ...
                    newWidget = new chiba.ui.range.Rating({
                        name:controlId + "-value",
                        value:xfValue,
                        "class":classValue,
                        title:dojo.attr(sourceNode,"title"),
                    ...
                    // Create Slider
                    newWidget= new chiba.ui.range.Slider({
                        value:xfValue,
                        name:controlId + "-value",
                        slideDuration:0,
                        minimum:start,
            ...
            case "secret":
                var xfValue = sourceNode.innerHTML;
                newWidget = new chiba.ui.secret.Secret({
                    name:controlId + "-value",
                    value:xfValue,
                    "class":classValue,
                    title:dojo.attr(sourceNode,"title"),
            ...
            /* Select Cases */
            case "selectCheckBox":
                newWidget = new chiba.ui.select.CheckBoxGroup({
                    name:controlId + "-value",
                    "class":classValue,
                    title:dojo.attr(sourceNode,"title"),
                    xfControlId:controlId
            ...
            case "selectList":
                newWidget = new chiba.ui.select.MultiSelect({
                    name:controlId + "-value",
            ...
            case "select1ComboBox":
                newWidget = new chiba.ui.select1.ComboBox({
                    name:controlId + "-value",
                    value:"",
                    "class":classValue,
                    title:dojo.attr(sourceNode,"title"),
            ...
            case "select1ComboBoxOpen":
                newWidget = new chiba.ui.select1.ComboBoxOpen({
                    name:controlId + "-value",
                    size:dojo.attr(sourceNode, "size"),
                    multiple:true,
                    "class":classValue,
            ...
            case "select1List":
                newWidget = new chiba.ui.select1.Plain({
                    name:controlId + "-value",
                    size:dojo.attr(sourceNode, "size"),
                    "class":classValue,
                    title:dojo.attr(sourceNode,"title"),
            ...
            case "select1RadioButton":
                newWidget = new chiba.ui.select1.RadioGroup({
                    name:controlId + "-value",
                    "class":classValue,
                    title:dojo.attr(sourceNode,"title"),
                    xfControlId:controlId
            ...
            case "textarea":
                if(dojo.attr(sourceNode,"appearance")=="minimal" && mediatype != 'text/html' && mediatype !=  'dojo') {
                    newWidget = new chiba.ui.textarea. MinimalTextarea({
                        name:controlId + "-value",
                        rows:5,
                        cols:40,
                        "class":classValue,
                    ...
                    if(mediatype == 'text/html') {
                        newWidget = new chiba.ui.textarea.HtmlEditor({
                            name:controlId + "-value",
                            "class":classValue,
                            title:dojo.attr(sourceNode,"title"),
                            xfControlId:controlId
                        ...
                        newWidget = new chiba.ui.textarea.DojoEditor({
                            name:controlId + "-value",
                            "class":classValue,
                            rows:5,
                            cols:30,
                        ...
                        newWidget = new chiba.ui.textarea.SimpleTextarea({
                            name:controlId + "-value",
                            "class":classValue,
                            title:dojo.attr(sourceNode,"title"),
                            xfControlId:controlId
            ...
            case "trigger":
                if(dojo.attr(sourceNode,"appearance")=="minimal") {
                    newWidget = new chiba.ui.trigger.LinkButton({
                    ...
                    newWidget = new chiba.ui.trigger.Button({
                        id:dojo.attr(sourceNode, "id"),
                        name:dojo.attr(sourceNode, "name")+"-value",
                        label:dojo.attr(sourceNode, "label"),
                        "class":classValue,
            ...
            case "upload":
                switch(dataType) {
                    ...
                    case "hexBinary":
                    case "anyURI":
                        newWidget = new chiba.ui.upload.UploadPlain({
                            "class":classValue,
                            title:dojo.attr(sourceNode,"title"),
                            xfControlId:controlId
                        }, sourceNode);
            ...
            case "radio":
               ...
               // 
                ...
                newWidget = new chiba.ui.select1.RadioButton({
                    "class":classValue,                    
                    name:name,
                    value:value,
                    title:dojo.attr(sourceNode,"title"),
                ...
                break;
            default:
                console.warn("Unknown controlValue: '" +controlType + "' for Control " + controlId + "! Properties: ", sourceNode);
                break;
        }
        return newWidget;
...
if(!dojo._hasResource["chiba.FluxProcessor"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
/**
    ...
    This class represents the interface to the remote XForms processor (aka 'Chiba Web') with DWR. It is the only class
    actually having dependency on DWR to handle the AJAX part of things and calling remote Java methods on
    org.chiba.web.chiba.FluxFacade.
**/
dojo.declare("chiba.FluxProcessor",
        chiba.XFormsProcessor,
{
    sessionKey:"",
    skipshutdown:false,
    isDirty:false,
...
*/
        ...
        dojo.forEach(data,
            function(xmlEvent) {
                ...
                switch (xmlEvent.type) {
                    case "chiba-load-uri"           : fluxProcessor._handleChibaLoadURI(xmlEvent); break;
                    case "xforms-version-exception" : alert(xmlEvent.contextInfo.errorinformation); break;
                    case "chiba-render-message"     : fluxProcessor._handleChibaRenderMessage(xmlEvent); break;
                    case "chiba-replace-all"        : fluxProcessor._handleChibaReplaceAll(); break;
                    case "chiba-state-changed"      : fluxProcessor._handleChibaStateChanged(xmlEvent); break;
                    case "chiba-insert-repeatitem"  : fluxProcessor._handleChibaInsertRepeatItem(xmlEvent); break;
                    case "chiba-insert-itemset"     : fluxProcessor._handleChibaInsertItemset(xmlEvent); break;
                    case "chiba-item-deleted"       : fluxProcessor._handleChibaItemDeleted(xmlEvent); break;
                    case "chiba-index-changed"      : fluxProcessor._handleChibaIndexChanged(xmlEvent); break;
                    case "chiba-switch-toggled"     : dijit.byId(xmlEvent.contextInfo.targetId).toggleCase(xmlEvent.contextInfo); break;
                    case "upload-progress-event"    : fluxProcessor._handleUploadProgressEvent(xmlEvent); break;
                    case "xforms-submit-error"      : console.warn("xforms-submit-error Event: ", xmlEvent); break;
                    case "chiba-script-action"      : eval(xmlEvent.contextInfo["script"]); break;
                    ...
                    case "chiba-id-generated"       : //  break;
                    case "xforms-hint"              : fluxProcessor._handleXFormsHint(xmlEvent); break;
                    default                         : console.warn("Event " + xmlEvent.type + " unknown [Event:",xmlEvent, "]"); break;
                }
            }
        );
    },

    _handleChibaLoadURI:function(/*XMLEvent*/ xmlEvent){
        ...
        // xf:load show=new
            ...
            window.open(xmlEvent.contextInfo.uri,'_chiba','menubar=yes,toolbar=yes,location=yes,directories=yes,fullscreen=no,titlebar=yes,hotkeys=yes,status=yes,scrollbars=yes,resizable=yes');
         ...
         */
            ...
            console.warn("chiba-load-uri show='"+xmlEvent.contextInfo.show+"' unknown!");
        }
    },


    _handleChibaRenderMessage:function(/*XMLEvent*/ xmlEvent){
        var message = xmlEvent.contextInfo.message;
        var level = xmlEvent.contextInfo.level;
        //
        if (level == "ephemeral") {
            dijit.byId("chibaMessageToaster").setContent(message,'message');
            dijit.byId("chibaMessageToaster").show();
        }
        else {
    ...
    _handleChibaStateChanged:function(/*XMLEvent*/ xmlEvent){
        // 
        this.isDirty = true;
        ...
        if(xmlEvent.contextInfo.targetName != undefined && xmlEvent.contextInfo.targetName == "repeat"){
            // 
            var repeatElement = dojo.query("*[repeatId='"+ xfControlId + "']");
         ...
         *          represent state-changed-events directly after chiba-item-inserted event
         *
         * **/

        else if(dojo.byId(xfControlId) != undefined){
            // 
            var controlNodeCreated = new chiba.ui.Control({contextInfo:xmlEvent.contextInfo},dojo.byId(xfControlId));
         ...
         * **/
            ...
            // parent diit does exist and executes handleStateChanged
            if(parentDijit != undefined) {
               // 
               parentDijit.handleStateChanged(xmlEvent.contextInfo);
            }
            // parent diit does not(!!) exist yet
            else {
                var parentControlNode = dojo.byId(xmlEvent.contextInfo.parentId);
                if(parentControlNode == undefined) {
                    console.warn("FluxProcessor chiba-state-changed  Warning: Neither Target nor its Parent does exist [xmlEvent" , xmlEvent, "]");                    
                }
                //  special handling for Select controls, check if parent node is selector item
                    ...
                    console.warn("FluxProcessor chiba-state-changed: No handleStateChanged implementation availabled for contextinfo: " , xmlEvent.contextInfo);
                }
            }
        }
        else  {
            console.warn("FluxProcessor chiba-state-changed Error: Processor does not know how to handle chiba-state-changed based on xmlEvent " , xmlEvent.contextInfo.targetId);
        }

    },

    _handleChibaInsertRepeatItem:function(xmlEvent) {
        // 
    ...
    _handleChibaInsertItemset:function(xmlEvent) {
        // 
        if (dijit.byId(xmlEvent.contextInfo.targetId) != undefined) {
            ...
            // 
            if (itemsetType != undefined && itemsetType == "chiba.ui.select.OptGroup") {
                itemsetDijit = new chiba.ui.select.OptGroup({contextInfo:xmlEvent.contextInfo}, itemsetDOM);
            }
            else if (itemsetType != undefined && itemsetType == "chiba.ui.select1.RadioItemset") {
                itemsetDijit = new chiba.ui.select1.RadioItemset({contextInfo:xmlEvent.contextInfo}, itemsetDOM);
            } else {
                console.warn("FluxProcessor apply chiba-insert-itemset: Itemset Type " + itemsetType + " not supported yet");
            }
            if (itemsetDijit != undefined) {
                itemsetDijit.handleInsert(xmlEvent.contextInfo);
            } else {
                console.warn("FluxProcessor apply chiba-insert-itemset: Error during itemset creation: ItemsetId" + xmlEvent.contextInfo.targetId + " itemsetType: " + itemsetType + " not supported yet");
            }
        }

    },
    _handleChibaItemDeleted:function(xmlEvent) {
        // 
    ...
    _handleChibaIndexChanged:function(xmlEvent) {
        var repeatElement = dojo.query("*[repeatId='"+xmlEvent.contextInfo.targetId + "']");
        var repeat = dijit.byId(dojo.attr(repeatElement[0],"id"));
        // 
    ...
    _handleUploadProgressEvent:function(xmlEvent) {
        ...
        if(dijit.byId(xfControlId) != undefined){
            ...
            console.warn("error during upload-progress-event: targetId " + xmlEvent.contextInfo.targetId + " does not exist");
        }
    },
    _handleXFormsFocus:function(xmlEvent) {
        // 
        var xfControlId = xmlEvent.contextInfo.targetId + "-value";

        if (xfControlId != undefined) {
            dojo.byId(xfControlId).focus();
        } else {
            console.warn("error during xforms-focus: targetId " + xmlEvent.contextInfo.targetId + " does not exist");
        }
    },
...
if(!dojo._hasResource["chiba.XFormsModelElement"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
**/
dojo.declare("chiba.XFormsModelElement",
        dijit._Widget,
{
    constructor: function() {
...
if(!dojo._hasResource["chiba.ui.Control"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        [dijit._Widget, dijit._Templated],
{
    ...
    buildRendering: function(){
            ...
            // TODO: verify if attachTemplatedNodes can be removed everywhere
    ...
    postCreate:function(){
        ...
        if (this.controlValue == undefined) {
            ...
            if (controlValueTemplate == undefined) {
               // 
                ...
                if(this.contextInfo.type != undefined){
                    var cssDataType = this.contextInfo.type;
                    if(cssDataType.indexOf(":")!= -1 ){
                        cssDataType = cssDataType.substring(cssDataType.indexOf(":")+1,cssDataType.length);
                    }
                    cssDataType = "xsd" + cssDataType.replace(/^[a-z]/,cssDataType.substring(0,1).toUpperCase())
                    if(dojo.hasClass(this.domNode, "xsd")){
                        chiba.ui.util.replaceClass(this.domNode, "xsd",cssDataType);
                    }else {
            ...
            // ControlValue node does allready exist
                ...
                this.dataType = dojo.attr(controlValueTemplate, "datatype");
...
/*    is called initially when controls initialize to read their state from
    ...
    handleStateChanged:function(contextInfo){        
        ...
        if (contextInfo["parentId"]) {
            ...
            if(this.datatype != null ){
                this._setTypeProperty(eval(contextInfo["type"]));
            }

            if (this.value != null) {
                if(contextInfo["type"]== "date") {
    ...
    _setTypeProperty:function(dataType){
        if(this.controlValue == undefined || this.dataType != dataType){
            var controlValueTemplate = dojo.query("*[id ='" + this.id + "-value']", this.domNode)[0];
            if(controlValueTemplate == undefined){
                controlValueTemplate = dojo.query(".xfValue", this.domNode)[0];
            }
    ...
    _handleSetEnabledProperty: function(){
        ...
        if (this.relevant == "true") {
            ...
            chiba.ui.util.replaceClass(label, "xfDisabled", "xfEnabled");
            // dojo.publish("/xf/enabled",[this])
        }
        else {
            chiba.ui.util.replaceClass(this.domNode, "xfEnabled", "xfDisabled");
            chiba.ui.util.replaceClass(label, "xfEnabled", "xfDisabled");
...
*/
    ...
    _setHint:function( value) {
        console.warn("TBD: Control._setHint value:"+ value);
/*
...
*/
    ...
    _setAlert:function( value) {
        console.warn("TBD: Control._setAlert value:"+ value);
    ...
    /*
     // original _handleSetReadonlyProperty
    _handleSetReadonlyProperty: function(){
            var targetId = target.getAttribute("id");
            if (this.type == "date" || this.type == "dateTime" || this.type == "time" || dojo.hasClass(dojo.byId(this.target), "date")) {
                var tmpWidget = dijit.byId(targetId + "-value");
                if (tmpWidget) {
                    tmpWidget.updateReadonly(this.readonly);
                }
            }
            var value = dijit.byId(targetId + "-value");
            if (value) {
...
if(!dojo._hasResource["chiba.ui.util"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["chiba.ui.util"] = true;
dojo.provide("chiba.ui.util");

chiba.ui.util.showAtWidget = function(widgetId) {
 ...
 */
/*
 chiba.ui.util.replaceClass = function (element, current, update) {
...
chiba.ui.util.getContainerByClass = function(/* node */ node, /*String*/ cssClass ){
    var body = dojo.body();
...
chiba.ui.util.removeStyle = function(element,styleToRemove) {
...
if(!dojo._hasResource["chiba.ui.container.Container"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.container.Group"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.container.ContentPaneGroup"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.container.Repeat"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
         ...
         chiba.ui.container.Container,
{
    ...
    handleSetRepeatIndex:function(/*Map*/ contextInfo){
        ...
        var repeatIndexNode = dojo.query(".xfRepeatItem", this.domNode)[contextInfo.index-1];
        // 
    ...
    handleInsert:function(/*Map*/ contextInfo){
        ...
        contextInfo.repeatedSelects
        var generatedIds ="";
        if (contextInfo.prototypeId != undefined) {
            // this._replacePrototypeIdsOld(insertedNode, contextInfo);
            ...
            // this._replacePrototypeIdsSelect(insertedNode, contextInfo.repeatedSelects);
    ...
    _createRepeatItem:function(/*Dijit*/node,/* int */position) {
        ...
        var repeatItemDijit =   new chiba.ui.container.RepeatItem({repeatId:this.id,appearance:appearance},node);
...
*/
    ...
    handleDelete:function(/*Map*/ contextInfo){
        var position = eval(contextInfo.position);
        var itemToRemove = dojo.query(".xfRepeatItem", this.domNode)[position-1];
...
if(!dojo._hasResource["chiba.ui.container.RepeatItem"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
*/
        ...
        _getRepeat:function() {
            ...
            while (!(dojo.hasClass(repeat, "xfRepeat")) && repeat != undefined) {
...
if(!dojo._hasResource["chiba.ui.container.Switch"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.container.TabSwitch"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare("chiba.ui.container.TabSwitch",
        [chiba.ui.container.Container,dijit.layout.TabContainer],
{
    ...
    onTabClicked:function(/*Event*/ evt){        
        ...
        fluxProcessor.dispatch(btnToActivate);
    ...
    _handleInvalid:function(control) {
        // 
        var affectedTab = chiba.ui.util.getContainerByClass(control.domNode,"xfCase");
...
if(!dojo._hasResource["chiba.ui.input.Boolean"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
//        
    ...
    getControlValue:function() {
        // 
        var checked =eval(this.attr('checked'));
...
if(!dojo._hasResource["chiba.ui.input.TextField"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        [chiba.ui.ControlValue,dijit.form.TextBox],
{
    ...
    // TODO: review _onChange() in all dijits and use _handleOnChange 
    _handleOnChange: function(/*anything*/ newValue, /*Boolean, optional*/ priorityChange){
...
if(!dojo._hasResource["chiba.ui.output.Html"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.output.Image"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.output.Link"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.output.Plain"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.range.Rating"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.range.Slider"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare(
        ...
        [chiba.ui.ControlValue,dijit.form.HorizontalSlider],
{
    postMixInProperties:function() {
        this.inherited(arguments);
        this.applyProperties(dijit.byId(this.xfControlId), this.srcNodeRef);
    ...
    _setValueAttr: function(value, priorityChange) {
        if (this.incremental && this.valueNode.value != value) {
            this.setControlValue();
        }
        this.inherited(arguments);
    },
...
if(!dojo._hasResource["chiba.ui.secret.Secret"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare(
        ...
        [chiba.ui.ControlValue,chiba.ui.input.TextField],
{
    type:"password"
...
if(!dojo._hasResource["chiba.ui.select1.ComboBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.select1.ComboBoxOpen"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare(
        ...
        [chiba.ui.ControlValue,dijit.form.ComboBox],
{
    postMixInProperties:function() {
        //
        this.inherited(arguments);
...
if(!dojo._hasResource["chiba.ui.select1.Plain"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.select1.RadioButton"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.select1.RadioGroup"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
/**
    ...
    CheckBoxGroup "Value Diit" represents a Select with appearance="full"
        Controller class for checkboxes (chiba.util.select.CheckBox) within Select Control
    ...
    postCreate:function() {
        ...
        dojo.query("*[controltype='radioButtonEntry']",this.domNode).forEach(
                function(xfNode){
                    ...
                    var option = new chiba.ui.Control({id:optionId,
...
if(!dojo._hasResource["chiba.ui.select1.RadioItemset"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
         ...
         dijit._Widget,
{
    ...
    handleInsert:function(contextInfo) {
        ...
        var controlDijit = new chiba.ui.Control({contextInfo:contextInfo}, itemNode);
/*
        var valueDijit = new chiba.ui.select1.RadioButton({
                id:itemId+"-value",
...
if(!dojo._hasResource["chiba.ui.select.CheckBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.select.CheckBoxGroup"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        dojo.forEach(dojo.query(".dijitCheckBoxInput", this.domNode),
            function(entry) {
                ...
                if(tmpDijit != undefined) {
                    ...
                    tmpDijit = new chiba.ui.select.CheckBox({},entryId);
                    tmpDijit.attr('disabled',disabled);
                }
            }
        );
...
if(!dojo._hasResource["chiba.ui.select.CheckBoxItemset"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
/**
	...
	@author Joern Turner
	@author Lars Windauer
    @see chiba.ui.select.CheckBoxGroup
    @date 2008.11.06
         ...
         [chiba.ui.ControlValue,dijit._Widget],
{
    ...
    /**
     * handle chiba-state-changed event
     * @param contextInfo
     */
    handleStateChanged:function(contextInfo) {
    ...
    handleInsert:function(contextInfo) {
        ...
        // 
        var valueNode = new chiba.ui.select.CheckBox({
                id:itemId+"-value",
                "class":"xfValue",
                type:"checkbox",
                value:contextInfo.value,
...
if(!dojo._hasResource["chiba.ui.select.MultiSelect"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.select.OptGroup"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.textarea.DojoEditor"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
{
    // !important: overwriten templateString of dijit.form.Textarea, otherwise duplicate ids are rendered (fieldset and div then have the same id!)
    templateString: (dojo.isIE || dojo.isSafari || dojo.isFF) ?
                ((dojo.isIE || dojo.isSafari || dojo.isFF >= 3) ? '<fieldset id="${id}-textarea" class="dijitInline" dojoAttachPoint="styleNode" waiRole="presentation"><div dojoAttachPoint="editNode,focusNode,eventNode" dojoAttachEvent="onpaste:_changing,oncut:_changing" waiRole="textbox" waiState="multiline-true" contentEditable="true"></div>'
                    : '<span id="${id}" class="dijitReset">'+
                    '<iframe src="javascript:<html><head><title>${_iframeEditTitle}</title></head><body><script>var _postCreate=window.frameElement?window.frameElement.postCreate:null;if(_postCreate)_postCreate();</script></body></html>"'+
                            ' dojoAttachPoint="iframe,styleNode,stateNode" dojoAttachEvent="onblur:_onIframeBlur" class="dijitInline dijitInputField"></iframe>')
                + '<textarea name="${name}" value="${value}" dojoAttachPoint="formValueNode" style="display:none;" autocomplete="off"></textarea>'
                + ((dojo.isIE || dojo.isSafari || dojo.isFF >= 3) ? '</fieldset>':'</span>')
            : '<textarea id="${id}-textarea" name="${name}" value="${value}" dojoAttachPoint="formValueNode,editNode,focusNode,styleNode">'+dojo.isFF+'</textarea>',
...
if(!dojo._hasResource["chiba.ui.textarea.HtmlEditor"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.textarea.SimpleTextarea"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource["chiba.ui.trigger.Button"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        [chiba.ui.ControlValue, dijit.form.Button],
{
   ...
   postMixInProperties:function() {
    ...
    _handleSetControlValue:function(value) {
        console.warn("TBD: chiba.ui.trigger.Button._handleSetControlValue: Value: ", value);        
    },
...
if(!dojo._hasResource["chiba.ui.trigger.LinkButton"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        chiba.ui.ControlValue,
{
    ...
    _setLabel:function(value) {
        console.warn("LinkButton._setLabel value:",value, " domNode: ",this.domNode);
    }
...
if(!dojo._hasResource["chiba.ui.upload.Upload"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
/*        [chiba.ui.ControlValue,dojox.form.FileInputOverlay],*/
        chiba.ui.ControlValue,
{
    postMixInProperties:function() {
        this.inherited(arguments);
...
if(!dojo._hasResource["chiba.ui.upload.UploadPlain"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.i18n._preloadLocalizations("chiba.nls.chiba", ["he","nl","tr","no","ko","el","en","en-gb","ROOT","zh-cn","hu","es","fi-fi","pt-br","ca","fi","he-il","xx","ru","it","fr","cs","de-de","fr-fr","it-it","es-es","ja","sk","da","sl","pl","de","sv","pt","pt-pt","nl-nl","zh-tw","ko-kr","ar","en-us","zh","th","ja-jp"]);
